...
Alternatively, Maptology can be run on a local computer. Versions 3.9+ of Python are supported. To start the app, run `streamlit run src/Maptology/main.py`. If that doesn't work, try one of these commands:
